...
const cities = [
    { name: 'Bogota', id: 'bogota', timezone: 'America/Bogota', flag: 'flags/colombia.png' },
    { name: 'Lima', id: 'lima', timezone: 'America/Lima', flag: 'flags/peru.png' },
    { name: 'Caracas', id: 'caracas', timezone: 'America/Caracas', flag: 'flags/venezuela.png' },
    { name: 'Buenos Aires', id: 'buenos-aires', timezone: 'America/Argentina/Buenos_Aires', flag: 'flags/argentina.png' },
    { name: 'Santiago de Chile', id: 'santiago-de-chile', timezone: 'America/Santiago', flag: 'flags/chile.png' },
    { name: 'Quito', id: 'quito', timezone: 'America/Lima', flag: 'flags/ecuador.png' },
    { name: 'La Paz', id: 'la-paz', timezone: 'America/La_Paz', flag: 'flags/Bolivia.png' },
    { name: 'Asuncion', id: 'asuncion', timezone: 'America/Caracas', flag: 'flags/paraguay.png' }
        ...
        const cityCard = `
            <section class="city-card" id="${city.id}">
                <div class="city-header">
                    <img src="${city.flag}" alt="Bandera de ${city.name}" class="flag-icon">
                    <h2>${city.name}</h2>
                </div>
...
const newsRegion = 'ar,cl,ve,co'; // Región para las noticias (cambiar si es necesario)
...
document.addEventListener('DOMContentLoaded', () => {
    updateNewsBanner();
    setInterval(updateNewsBanner, 30 * 60 * 1000); // Actualizar cada 30 minutos
});
